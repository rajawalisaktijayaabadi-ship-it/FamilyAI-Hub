...
const mockChildren: Child[] = [
  {
    ...
    grade: 'Kelas 5 SD',
    bloodType: 'O+',
    allergies: ['Kacang Tanah', 'Debu'],
    hobbies: ['Membaca Komik Sains', 'Bermain Catur', 'Lego Robotics'],
    interests: ['Astronomi', 'Koding Scratch', 'Sepeda Gunung'],
    talents: ['Matematika Logika', 'Gambar Ilustrasi'],
    goals: ['Membaca 10 Buku Sains', 'Juara Catur Sekolah', 'Juara Kebersihan Kamar'],
    parentNotes: 'Arsa anak yang sangat ingin tahu hal ilmiah, perlu pendampingan saat manajemen waktu layar.',
    createdAt: '2026-01-01'
  },
  {
    id: 'child-2',
    familyId: 'fam-1',
    name: 'Bening Putri Kirana',
    photo: 'https://images.unsplash.com/photo-1595454038955-4dfe8de81be8?auto=format&fit=crop&q=80&w=250',
    birthDate: '2020-08-20',
    age: 6,
    gender: 'Perempuan',
    school: 'TK Permata Hati',
    grade: 'TK B',
    bloodType: 'A+',
    allergies: ['Susu Sapi (Toleransi Rendah)'],
    hobbies: ['Menari Balet', 'Mewarnai', 'Menyanyi'],
    interests: ['Hewan Peliharaan', 'Dongeng Seri Putri', 'Origami'],
    talents: ['Daya Ingat Lagu', 'Seni Warna'],
    goals: ['Membaca Al-Qur\'an Juz Amma', 'Lancar Bersepeda Roda Dua'],
    parentNotes: 'Bening bersikap sangat empati pada teman, menyukai pujian positif saat merapikan mainan.',
    createdAt: '2026-01-01'
  }
];
...
const mockGrowthRecords: GrowthRecord[] = [
  {
    ...
    notes: 'Pertumbuhan tinggi badan naik 1.2 cm dalam 2 bulan. Postur tubuh sangat ideal.',
    recordedBy: 'Ibu'
  },
  {
    id: 'growth-2',
    ...
    heightCm: 137.3,
    weightKg: 31.8,
    headCircumferenceCm: 52.0,
    bmi: 16.8,
    category: 'Physical Growth',
    notes: 'Pemeriksaan rutin dokter kecil sekolah.',
    recordedBy: 'Ayah'
  },
  {
    id: 'growth-3',
    ...
    heightCm: 112.0,
    weightKg: 19.5,
    headCircumferenceCm: 49.5,
    bmi: 15.5,
    category: 'Physical Growth',
    notes: 'Bertambah tinggi dengan berat badan stabil.',
    recordedBy: 'Ibu'
  }
];
